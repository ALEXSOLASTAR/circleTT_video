...
def creat_sprite_list(amount, sprite_width, sprite_hight, speed, colors):
    ...
    retreat_of_border = 50 - retreat+50
    ...
    for i in range(amount):
        ...
        sprits_dict["color"] = colors[i*-1] #(random.uniform(0, 256), random.uniform(0, 256), random.uniform(0, 256))
        sprits_dict["speed"] = speed + speed*i*0.03
